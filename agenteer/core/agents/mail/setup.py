"""
Mail setup wizard for Agenteer.
...
# Import providers
from agenteer.core.agents.mail.providers import get_mail_provider
...
async def setup_mail_provider(
    ...
    if not interactive:
        ...
        if provider_type.lower() == 'gmail':
            ...
            if not credentials_file:
                ...
                credentials_file = os.path.expanduser('~/.agenteer/gmail_credentials.json')
    ...
    print("\n=== Agenteer Mail Setup ===\n")
    print("This wizard will help you set up email access for Agenteer.")
...
async def setup_gmail_oauth() -> Dict[str, Any]:
    ...
    if not os.path.exists(credentials_file):
        ...
        print("6. Save it as ~/.agenteer/gmail_credentials.json")
    ...
    if os.path.exists(credentials_file):
        ...
        print("\n❌ Gmail credentials not found at ~/.agenteer/gmail_credentials.json")
...
async def setup_outlook_oauth() -> Dict[str, Any]:
    ...
    if not settings.outlook_client_id:
        ...
        # Test authentication
        from agenteer.core.agents.mail.providers import OutlookProvider
