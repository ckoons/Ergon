...
This module provides a FastAPI-based REST API for Agenteer,
...
from agenteer.core.database.models import Agent, AgentFile, AgentTool, AgentExecution, AgentMessage, DocumentationPage
from agenteer.core.agents.generator import AgentGenerator
from agenteer.core.agents.runner import AgentRunner
from agenteer.core.docs.crawler import crawl_all_docs, crawl_pydantic_ai_docs, crawl_langchain_docs, crawl_anthropic_docs
...
app = FastAPI(
    title="Agenteer API",
    description="REST API for the Agenteer AI agent builder",
    version="0.1.0"
)
...
# Run with: uvicorn agenteer.api.app:app --host 0.0.0.0 --port 8000
