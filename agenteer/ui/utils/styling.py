"""
UI styling utilities for Agenteer
"""
...
def display_logo():
    """Display the Agenteer logo in sidebar"""
    ...
    st.markdown("<h1>Agenteer</h1>", unsafe_allow_html=True)
    st.markdown("<h4>The Intelligent Agent Builder</h4>", unsafe_allow_html=True)
    
def display_logo_centered():
    """Display the Agenteer logo centered in main content - removed per design requirement"""
    # We no longer show the logo on main pages, only in sidebar
    st.markdown("<h1 style='text-align: center;'>Agenteer</h1>", unsafe_allow_html=True)
