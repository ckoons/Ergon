"""
Documentation management page for Agenteer.
...
def documentation_page():
    ...
    st.markdown("Manage documentation sources for use with Agenteer agents")
                ...
                if not custom_url.startswith("http"):
                    ...
                    with st.spinner("Crawling..."):
                        try:
                            ...
                            from agenteer.core.docs.crawler import DocumentationCrawler
